...
public class BlthConnectionService {
    private static final String TAG = "BlthConnectionServ";
    private static final String appName = "LiroyMerlin";
    ...
    //constructor
    public BlthConnectionService(Context context) {
        mContext = context;
